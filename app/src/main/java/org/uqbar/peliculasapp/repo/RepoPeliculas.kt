 ...
 */
/**
 * Created by Meningas on 6/12/18.
 */
    ...
    private fun init() {
        ...
        agregarPelicula(
            Pelicula(
                "Los intocables",
                getGenero("Clasicos"),
                "Chicago, años 30. Época de la Ley Seca. El idealista agente federal Eliot Ness persigue implacablemente al gángster Al Capone. La falta de pruebas le impide acusarlo de asesinato, extorsión y comercio ilegal de alcohol, pero encontrará un medio para inculparlo por otra clase de delitos.Duración: 119 min",
